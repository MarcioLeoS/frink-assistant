...
mysql -uroot -p"${MYSQL_ROOT_PASSWORD}" -e "CREATE DATABASE IF NOT EXISTS \`${FRINK_DB}\`;"
mysql -uroot -p"${MYSQL_ROOT_PASSWORD}" -e "ALTER DATABASE \`${FRINK_DB}\` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"
